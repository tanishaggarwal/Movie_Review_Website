<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteAccount.aspx.cs" Inherits="Movie_Review_Website.DeleteAccount" %>
 ...
 <img src="images/Login.jpg" alt=""/>
  ...
  <h3 data-edit="text">Once Deleted It Can&#39;t Be Retrived</h3>
    ...
    <table class="auto-style1">
       ...
       <asp:Button ID="ButtonLogin" runat="server" Text="DELETE" class="ebook-input-btn" OnClick="ButtonLogin_Click"/>      
        <br />
  </div>
</div>
</section>
